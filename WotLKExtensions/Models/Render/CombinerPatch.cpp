...
#include "Models/Render/Shaders/CombinersModAddAlphaPs.h"
#include "Models/Render/Shaders/CombinersModAddAlphaVs.h"

#include "Models/Common/ModelHooks.h"
#include "Models/Client/GxBindings.h"
#include "Models/Offsets/GxOffsets.h"
#include "Models/Offsets/ShaderOffsets.h"
...
namespace
{
    namespace shoff = ModernM2::Offsets::Shader;
    ...
    {
        auto* dev = static_cast<IDirect3DDevice9*>(ModernM2::Gx::RawDevice());
...
namespace ModernM2
{
    ...
    {
        g_enabled = ConfigU32("HOT_M2_COMBINER_PATCH", 1, 0, 1) != 0;
        HookAttach("Shader.EffectBind", shoff::kEffectBind, &hkEffectBind, &g_origEffectBind);
