...
namespace
{
    ...
    {
        // 0x0081D510 carries exactly one detour, so the wide-skin picking remap rides this one.
        ModernM2::WideIndices::RemapHitTestRange(&indexBegin, &indexEnd);
        __try
        {
...
namespace ModernM2
{
    ...
    {
        HookAttach("M2.SceneTriangleHitTest", m2::kSceneTriangleHitTest, &hkSceneTriangleHitTest,
                  &g_origSceneTriangleHitTest);
        HookAttach("M2.SortOpaqueGeoBatches", m2::kSortOpaqueGeoBatches, &hkSortOpaqueGeoBatches,
                  &g_origSortOpaqueGeoBatches);
        return true;
    }
}
