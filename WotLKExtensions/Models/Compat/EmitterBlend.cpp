...
namespace
{
    namespace gx  = ModernM2::Offsets::Gx;
    ...
    uint32_t __fastcall hkInitializeLoaded(void* model, void* edx)
    {
        ...
        const auto* header = reinterpret_cast<const ModernM2::Format::M2Header*>(
...
namespace ModernM2
{
    ...
    {
        if (!HookAttach("M2.InitializeLoaded", ModernM2::Offsets::M2::kInitializeLoaded,
                       &hkInitializeLoaded, &g_origInitializeLoaded))
            return false;
