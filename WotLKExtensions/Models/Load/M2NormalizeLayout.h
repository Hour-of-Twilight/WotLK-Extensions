...
namespace ModernM2::Reader::Detail
{
    ...
    struct NormalizeCtx
    {
        uint8_t*                  body;
        uint32_t                  size;
        ModernM2::Format::M2Header*  header;
    };
    ...
    inline constexpr RecordNormalizer kRecordNormalizers[] = {
        { offsetof(ModernM2::Format::M2Header, particleEmitters),
          ModernM2::Offsets::M2::kParticleStrideModern, ModernM2::Offsets::M2::kParticleStrideClient,
          ModernM2::Offsets::M2::kParticleModernMinVer, &NormalizeParticleRecord, "particles" },
        { offsetof(ModernM2::Format::M2Header, cameras),
          ModernM2::Offsets::M2::kCameraStrideModern, ModernM2::Offsets::M2::kCameraStrideClient,
          ModernM2::Offsets::M2::kCameraModernMinVer, &NormalizeCameraRecord, "cameras" },
    };
