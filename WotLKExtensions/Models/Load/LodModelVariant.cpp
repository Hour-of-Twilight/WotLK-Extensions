...
#include "Models/Load/LodModelVariant.h"
#include "Models/Common/ModelHooks.h"

#include "Models/Offsets/IoOffsets.h"
...
namespace
{
    namespace io = ModernM2::Offsets::Io;
...
namespace ModernM2
{
    ...
    {
        HookAttach("Storage.FileOpen", io::kFileOpen, &hkFileOpen, &g_origFileOpen);
        g_installed = true;
