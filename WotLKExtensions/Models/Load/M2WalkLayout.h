...
namespace ModernM2::Reader::Detail
{
    ...
    inline constexpr HeaderArray kHeaderArrays[] = {
        { offsetof(ModernM2::Format::M2Header, name),                  0x01, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, globalLoops),           0x04, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, sequences),             0x40, kArraySequenceFlags, nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, sequenceLookup),        0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, bones),                 0x58, kArrayPlain,         kBoneSteps,             StepCount(kBoneSteps) },
        { offsetof(ModernM2::Format::M2Header, boneLookup),            0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, vertices),              0x30, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, colors),                0x28, kArrayPlain,         kColorSteps,            StepCount(kColorSteps) },
        { offsetof(ModernM2::Format::M2Header, textures),              0x10, kArrayPlain,         kTextureSteps,          StepCount(kTextureSteps) },
        { offsetof(ModernM2::Format::M2Header, textureWeights),        0x14, kArrayPlain,         kTextureWeightSteps,    StepCount(kTextureWeightSteps) },
        { offsetof(ModernM2::Format::M2Header, textureTransforms),     0x3C, kArrayPlain,         kTextureTransformSteps, StepCount(kTextureTransformSteps) },
        { offsetof(ModernM2::Format::M2Header, textureReplacements),   0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, materials),             0x04, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, boneCombos),            0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, textureCombos),         0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, textureUnitLookup),     0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, textureWeightCombos),   0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, textureTransformCombos),0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, collisionIndices),      0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, collisionPositions),    0x0C, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, collisionNormals),      0x0C, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, attachments),           0x28, kArrayPlain,         kAttachmentSteps,       StepCount(kAttachmentSteps) },
        { offsetof(ModernM2::Format::M2Header, attachmentLookup),      0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, events),                0x24, kArrayPlain,         kEventSteps,            StepCount(kEventSteps) },
        { offsetof(ModernM2::Format::M2Header, lights),                0x9C, kArrayPlain,         kLightSteps,            StepCount(kLightSteps) },
        { offsetof(ModernM2::Format::M2Header, cameras),               0x64, kArrayPlain,         kCameraSteps,           StepCount(kCameraSteps) },
        { offsetof(ModernM2::Format::M2Header, cameraLookup),          0x02, kArrayPlain,         nullptr, 0 },
        { offsetof(ModernM2::Format::M2Header, ribbonEmitters),        0xB0, kArrayPlain,         kRibbonSteps,           StepCount(kRibbonSteps) },
        { offsetof(ModernM2::Format::M2Header, particleEmitters),     0x1DC, kArrayPlain,         kParticleSteps,         StepCount(kParticleSteps) },
        { offsetof(ModernM2::Format::M2Header, textureCombinerCombos), 0x02, kArrayCombinerGated, nullptr, 0 },
    };
}
